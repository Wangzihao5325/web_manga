    ...
    render() {
        return (
            <div style={{ borderRadius: 11, height: 396, width: 290, backgroundColor: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <div style={{ marginTop: 20, height: 28, width: 178, borderRadius: 14, backgroundColor: 'rgb(234,234,234)', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>官网地址:1111111</div>
